pipeline {
    ...
    environment {
        ...
        RESOURCE_POOL = "muavvcrp01.mcs.miamioh.edu/Regional/ClusterCIT/muavesrp03.mcs.miamioh.edu/"
        VM_FOLDER = "muavvcrp01.mcs.miamioh.edu/Regional/CIT Prod Server VMs/Senior Project Machines/"
    }
